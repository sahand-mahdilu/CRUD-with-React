...
export default function ProductCart(props: ProductCartProps) {
  ...
  return (
    <div
      className={
        available
          ? "flex flex-col items-center gap-5  border-2 hover:bg-blue-950 transition-all  p-3 rounded-2xl"
          : "flex flex-col items-center gap-5  border-2 hover:bg-blue-950 transition-all  p-3 rounded-2xl bg-slate-500"
      }
    >
      ...
      {available ? (
        ...
        <p className="text-red-600 font-bold text-xl">not available</p>
      )}
      ...
      <button
        ...
        className={
          available
            ? "p-1 px-2 rounded-lg bg-green-400"
            : "p-1 px-2 rounded-lg bg-red-400"
        }
      >
        Add to cart
      </button>
      ...
      <Link
        className="bg-blue-500 p-2 rounded-md hover:bg-blue-300 cursor-pointer"
        to={`/singleproduct/${id}`}
      >
        {" "}
        <span>
